...
urlpatterns = patterns('',
    ...
    url(r'^xforms/list/(?P<domain_name>.*)$', 'xformmanager.views.list_xforms', name='list_xforms'),    
    url(r'^xforms/download/(?P<formdef_id>.*)$', 'xformmanager.views.download_xform', name='download_xform'),
